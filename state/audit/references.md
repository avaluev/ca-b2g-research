...
- Total references: **11919**
- Unique (kind, target) pairs: **1183**
- OK: **691**
- Broken: **492**
...
- **[0]** `https://bhuvan.nrsc.gov.in/ngmaps` — The read operation timed out
    - referenced by `state/audit/link_report.json#$.results[529].final_url`
    - referenced by `state/audit/references.json#$.ok[179].samples[0]`
    - referenced by `state/audit/references.json#$.ok[179].samples[1]`
    - referenced by `state/audit/references.json#$.ok[179].samples[2]`
    - referenced by `state/audit/references.json#$.ok[179].target`
    - sample: `https://bhuvan.nrsc.gov.in/ngmaps`
- **[0]** `https://boesl.gov.bd/` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.
    ...
    - referenced by `state/audit/references.json#$.broken[16].samples[0]`
    - referenced by `state/audit/references.json#$.broken[16].samples[1]`
    - referenced by `state/audit/references.json#$.broken[16].samples[2]`
...
- **[0]** `https://cbd.m` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[17].target`
    - referenced by `state/audit/references.json#$.broken[190].samples[2]`
    - sample: `https://cbd.m`
...
- **[0]** `https://digi` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    - referenced by `state/audit/references.json#$.broken[24].samples[0]`
    - referenced by `state/audit/references.json#$.broken[24].samples[1]`
    - referenced by `state/audit/references.json#$.broken[24].samples[2]`
    - referenced by `state/audit/references.json#$.broken[24].target`
    - referenced by `state/audit/references.json#$.broken[300].samples[0]`
    - sample: `https://digi`
...
- **[0]** `https://dtm.uz/` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.
    ...
    - referenced by `state/audit/references.json#$.broken[32].target`
...
- **[0]** `https://eabr.org/en/about/facts-and-f` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.
    - referenced by `state/audit/references.json#$.broken[36].samples[0]`
    ...
    - referenced by `state/audit/references.json#$.broken[36].target`
...
- **[0]** `https://eabr.org/en/about/facts-and-figures/` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.
    ...
    - referenced by `state/audit/references.json#$.broken[37].samples[1]`
...
- **[0]** `https://eabr.org/en/p` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.
    ...
    - referenced by `state/audit/references.json#$.broken[38].samples[2]`
    - referenced by `state/audit/references.json#$.broken[38].target`
...
- **[0]** `https://eabr.org/en/press/news/the-edb-fund-for-digital-initiatives-expands-cooperation-with-the-republic-of-uzbekistan-in-the-fiel/` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.
    ...
    - referenced by `state/audit/references.json#$.broken[40].samples[1]`
    - referenced by `state/audit/references.json#$.broken[40].samples[2]`
...
- **[0]** `https://fvv.uz/` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: Hostname mismatch, certificate is not valid f
    ...
    - referenced by `state/audit/references.json#$.broken[45].samples[0]`
    - referenced by `state/audit/references.json#$.broken[45].samples[1]`
    - referenced by `state/audit/references.json#$.broken[45].samples[2]`
    - referenced by `state/audit/references.json#$.broken[45].target`
...
- **[0]** `https://github.c` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.ok[252].samples[0]`
...
- **[0]** `https://grs.gov.kg/` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[49].samples[0]`
    - referenced by `state/audit/references.json#$.broken[49].samples[1]`
    - referenced by `state/audit/references.json#$.broken[49].samples[2]`
...
- **[0]** `https://icwc-aral.uz/` — <urlopen error [Errno 61] Connection refused>
    ...
    - referenced by `state/audit/references.json#$.broken[51].samples[0]`
...
- **[0]** `https://it-park.uz` — Remote end closed connection without response
...
- **[0]** `https://jica.go.jp` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[55].samples[0]`
    - referenced by `state/audit/references.json#$.broken[55].samples[1]`
    - referenced by `state/audit/references.json#$.broken[55].samples[2]`
...
- **[0]** `https://kazvod.gov.kz/` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[57].samples[2]`
...
- **[0]** `https://l` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    - referenced by `state/audit/references.json#$.broken[59].samples[0]`
    - referenced by `state/audit/references.json#$.broken[59].samples[1]`
    - referenced by `state/audit/references.json#$.broken[59].samples[2]`
    - referenced by `state/audit/references.json#$.broken[59].target`
    - referenced by `state/audit/references.json#$.ok[393].samples[1]`
    - sample: `https://l`
- **[0]** `https://le` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.ok[405].samples[1]`
    - sample: `https://le`
- **[0]** `https://lex` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.ok[395].samples[1]`
    - sample: `https://lex`
...
- **[0]** `https://minvoda.uz` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[77].samples[1]`
    - referenced by `state/audit/references.json#$.broken[77].samples[2]`
...
- **[0]** `https://nbki.uz` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[80].samples[1]`
    - referenced by `state/audit/references.json#$.broken[80].samples[2]`
...
- **[0]** `https://negu.uz` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: Hostname mismatch, certificate is not valid f
    ...
    - referenced by `state/audit/references.json#$.broken[81].target`
...
- **[0]** `https://osh.kg` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: certificate has expired (_ssl.c:1007)>
    ...
    - referenced by `state/audit/references.json#$.broken[83].samples[1]`
    - referenced by `state/audit/references.json#$.broken[83].samples[2]`
...
- **[0]** `https://projects.w` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    - referenced by `state/audit/references.json#$.broken[86].samples[0]`
    - referenced by `state/audit/references.json#$.broken[86].samples[1]`
    - referenced by `state/audit/references.json#$.broken[86].samples[2]`
    - referenced by `state/audit/references.json#$.broken[86].target`
    - referenced by `state/audit/references.json#$.ok[453].samples[0]`
...
- **[0]** `https://projects.worldbank` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.ok[447].samples[0]`
...
- **[0]** `https://ranking.e.gov.kz/en/` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[89].samples[0]`
    - referenced by `state/audit/references.json#$.broken[89].samples[1]`
    - referenced by `state/audit/references.json#$.broken[89].samples[2]`
...
- **[0]** `https://socfond.kg/` — <urlopen error [Errno 61] Connection refused>
    ...
    - referenced by `state/audit/references.json#$.broken[95].target`
...
- **[0]** `https://tis.nhai.gov.in/` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: certificate has expired (_ssl.c:1007)>
    ...
    - referenced by `state/audit/references.json#$.broken[100].samples[0]`
    - referenced by `state/audit/references.json#$.broken[100].samples[1]`
    - referenced by `state/audit/references.json#$.broken[100].samples[2]`
...
- **[0]** `https://torelik.gov.kz/` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[101].samples[0]`
    - referenced by `state/audit/references.json#$.broken[101].samples[1]`
    - referenced by `state/audit/references.json#$.broken[101].samples[2]`
...
- **[0]** `https://uzposta.uz` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[104].samples[1]`
    - referenced by `state/audit/references.json#$.broken[104].samples[2]`
...
- **[0]** `https://uztrade.uz/` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: self-signed certificate (_ssl.c:1007)>
    ...
    - referenced by `state/audit/references.json#$.broken[105].samples[0]`
    ...
    - referenced by `state/audit/references.json#$.broken[105].target`
...
- **[0]** `https://vacancy.uz/` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[106].samples[0]`
    ...
    - referenced by `state/audit/references.json#$.broken[106].target`
...
- **[0]** `https://ww` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[111].target`
...
- **[0]** `https://www.a` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[112].target`
...
- **[0]** `https://www.donors.kg/en/agencie` — <urlopen error timed out>
...
- **[0]** `https://www.gov.kg` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.
    ...
    - referenced by `state/audit/references.json#$.broken[118].target`
...
- **[0]** `https://www.it-park.uz/en/itpark` — Remote end closed connection without response
...
- **[0]** `https://www.koica.go.kr/sites/koica_en/country/asia/` — <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.
    ...
    - referenced by `state/audit/references.json#$.broken[126].samples[0]`
    - referenced by `state/audit/references.json#$.broken[126].samples[1]`
    - referenced by `state/audit/references.json#$.broken[126].samples[2]`
...
- **[0]** `https://www.linked` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[129].target`
...
- **[0]** `https://www.tazabe` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[139].target`
    - referenced by `state/audit/references.json#$.ok[648].samples[0]`
...
- **[0]** `https://www.un` — <urlopen error [Errno 8] nodename nor servname provided, or not known>
    ...
    - referenced by `state/audit/references.json#$.broken[140].target`
    - referenced by `state/audit/references.json#$.broken[280].samples[0]`
    - sample: `https://www.un`
...
- **[401]** `https://www.itu.int/en/ITU-D/Regional-Presence/CIS/Pages/News` 
    - referenced by `state/audit/references.json#$.broken[145].samples[0]`
    - referenced by `state/audit/references.json#$.broken[145].samples[1]`
    - referenced by `state/audit/references.json#$.broken[145].samples[2]`
    - referenced by `state/audit/references.json#$.broken[145].target`
    - referenced by `state/audit/references.json#$.ok[598].samples[0]`
...
- **[403]** `http://cbd.minjust.gov.kg/act/view/ru-ru/1` 
    ...
    - referenced by `state/audit/references.json#$.broken[146].target`
...
- **[403]** `http://cbd.minjust.gov.kg/act/view/ru-ru/111125` 
    ...
    - referenced by `state/audit/references.json#$.broken[147].samples[0]`
    - referenced by `state/audit/references.json#$.broken[147].samples[1]`
...
- **[403]** `http://cbd.minjust.gov.kg/act/view/ru-ru/14544` 
    ...
    - referenced by `state/audit/references.json#$.broken[150].samples[2]`
...
- **[403]** `http://cbd.minjust.gov.kg/act/view/ru-ru/157967` 
    ...
    - referenced by `state/audit/references.json#$.broken[151].samples[2]`
...
- **[403]** `http://cbd.minjust.gov.kg/act/view/ru-ru/159060` 
    ...
    - referenced by `state/audit/references.json#$.broken[152].samples[0]`
...
- **[403]** `https://abdm.gov.in/` 
    ...
    - referenced by `state/audit/references.json#$.broken[154].samples[1]`
...
- **[403]** `https://adb.org` 
    ...
    - referenced by `state/audit/references.json#$.broken[155].samples[1]`
    - referenced by `state/audit/references.json#$.broken[155].samples[2]`
    - referenced by `state/audit/references.json#$.broken[155].target`
...
- **[403]** `https://adb.org/countries/uzbekistan` 
    ...
    - referenced by `state/audit/references.json#$.broken[156].samples[1]`
    - referenced by `state/audit/references.json#$.broken[156].samples[2]`
    - referenced by `state/audit/references.json#$.broken[156].target`
...
- **[403]** `https://adb.org/projects/55109-001` 
    ...
    - referenced by `state/audit/references.json#$.broken[158].samples[0]`
...
- **[403]** `https://cbd.minjust.gov.kg/112282/edit` 
    ...
    - referenced by `state/audit/references.json#$.broken[161].samples[2]`
    - referenced by `state/audit/references.json#$.broken[161].target`
    - referenced by `state/audit/references.json#$.broken[162].samples[1]`
...
- **[403]** `https://cbd.minjust.gov.kg/112333/edition/1263145/` 
    ...
    - referenced by `state/audit/references.json#$.broken[163].samples[1]`
    - referenced by `state/audit/references.json#$.broken[163].samples[2]`
    - referenced by `state/audit/references.json#$.broken[163].target`
...
- **[403]** `https://cbd.minjust.gov.kg/15479/edition/962966/` 
    ...
    - referenced by `state/audit/references.json#$.broken[167].samples[2]`
    - referenced by `state/audit/references.json#$.broken[167].target`
    - referenced by `state/audit/references.json#$.broken[168].samples[1]`
...
- **[403]** `https://cbd.minjust.gov.kg/202269/editi` 
    - referenced by `state/audit/references.json#$.broken[169].samples[0]`
    - referenced by `state/audit/references.json#$.broken[169].samples[1]`
    - referenced by `state/audit/references.json#$.broken[169].samples[2]`
    - referenced by `state/audit/references.json#$.broken[169].target`
...
- **[403]** `https://cbd.minjust.gov.kg/3-48` 
    ...
    - referenced by `state/audit/references.json#$.broken[174].samples[1]`
    - referenced by `state/audit/references.json#$.broken[174].samples[2]`
    - referenced by `state/audit/references.json#$.broken[174].target`
...
- **[403]** `https://cbd.minjust.gov.kg/30-164` 
    ...
    - referenced by `state/audit/references.json#$.broken[176].samples[0]`
    - referenced by `state/audit/references.json#$.broken[176].samples[1]`
    - referenced by `state/audit/references.json#$.broken[176].samples[2]`
    - referenced by `state/audit/references.json#$.broken[176].target`
...
- **[403]** `https://cbd.minjust.gov.kg/4-5371/ed` 
    - referenced by `state/audit/references.json#$.broken[178].samples[0]`
    - referenced by `state/audit/references.json#$.broken[178].samples[1]`
    - referenced by `state/audit/references.json#$.broken[178].samples[2]`
    - referenced by `state/audit/references.json#$.broken[178].target`
...
- **[403]** `https://cbd.minjust.gov.kg/5-10789/edition/24270/ru` 
    ...
    - referenced by `state/audit/references.json#$.broken[186].samples[0]`
...
- **[403]** `https://cbd.minjust.gov.kg/5-10844/edition/28166/ru` 
    ...
    - referenced by `state/audit/references.json#$.broken[187].samples[0]`
...
- **[403]** `https://cbd.minjust.gov.kg/5-10845/edition/28311/ru` 
    ...
    - referenced by `state/audit/references.json#$.broken[188].samples[0]`
...
- **[403]** `https://cbd.minjust.gov.kg/7-26125/edition/7070/ru` 
    ...
    - referenced by `state/audit/references.json#$.broken[192].samples[0]`
...
- **[403]** `https://cbd.minjust.gov.kg/7-31402/edition/15114/ru` 
    ...
    - referenced by `state/audit/references.json#$.broken[193].samples[0]`
...
- **[403]** `https://cbd.minjust.gov.kg/7-44235/edition/36804/r` 
    ...
    - referenced by `state/audit/references.json#$.broken[197].samples[1]`
    - referenced by `state/audit/references.json#$.broken[197].samples[2]`
    - referenced by `state/audit/references.json#$.broken[197].target`
    - referenced by `state/audit/references.json#$.broken[198].samples[2]`
...
- **[403]** `https://cbd.minjust.gov.kg/act/view/ru-ru/111634` 
    ...
    - referenced by `state/audit/references.json#$.broken[201].samples[0]`
    - referenced by `state/audit/references.json#$.broken[201].samples[1]`
    - referenced by `state/audit/references.json#$.broken[201].samples[2]`
    - referenced by `state/audit/references.json#$.broken[201].target`
...
- **[403]** `https://cbd.minjust.gov.kg/act/view/ru-ru/11736` 
    ...
    - referenced by `state/audit/references.json#$.broken[202].samples[0]`
    - referenced by `state/audit/references.json#$.broken[202].samples[1]`
    - referenced by `state/audit/references.json#$.broken[202].samples[2]`
...
- **[403]** `https://cbd.minjust.gov.kg/act/view/ru-ru/159060` 
    ...
    - referenced by `state/audit/references.json#$.broken[205].target`
...
- **[403]** `https://cbd.minjust.gov.kg/{rubric` 
    ...
    - referenced by `state/audit/references.json#$.broken[209].target`
...
- **[403]** `https://documents.worldbank.org/en/publication/d` 
    - referenced by `state/audit/references.json#$.broken[302].samples[0]`
    - referenced by `state/audit/references.json#$.broken[302].samples[1]`
    - referenced by `state/audit/references.json#$.broken[302].samples[2]`
    - referenced by `state/audit/references.json#$.broken[302].target`
...
- **[403]** `https://esanjeevani.mohfw.gov.in/` 
    ...
    - referenced by `state/audit/references.json#$.broken[213].samples[1]`
    - referenced by `state/audit/references.json#$.broken[213].samples[2]`
...
- **[403]** `https://knews.kg/2026/04/30/mintsifry-kyr` 
    ...
    - referenced by `state/audit/references.json#$.broken[216].target`
    - referenced by `state/audit/references.json#$.broken[217].samples[0]`
...
- **[403]** `https://knews.kg/2026/04/30/mintsifry-kyrgyzstana-uprazdnili-ego-prisoedinili-k-upravdelami-prezidenta/` 
    ...
    - referenced by `state/audit/references.json#$.broken[217].samples[1]`
    - referenced by `state/audit/references.json#$.broken[217].samples[2]`
...
- **[403]** `https://president.kg/` 
    ...
    - referenced by `state/audit/references.json#$.broken[221].samples[0]`
    - referenced by `state/audit/references.json#$.broken[221].samples[1]`
    - referenced by `state/audit/references.json#$.broken[221].samples[2]`
    - referenced by `state/audit/references.json#$.broken[221].target`
    - sample: `**Evidence**: https://president.kg/`
- **[403]** `https://sal.org.sg/` 
    - referenced by `state/audit/link_report.json#$.results[676].final_url`
    - referenced by `state/audit/references.json#$.broken[222].samples[0]`
    - referenced by `state/audit/references.json#$.broken[222].samples[1]`
    - referenced by `state/audit/references.json#$.broken[222].samples[2]`
    - referenced by `state/audit/references.json#$.broken[222].target`
...
- **[403]** `https://undp.org/kyrgyzstan` 
    ...
    - referenced by `state/audit/references.json#$.broken[223].samples[0]`
...
- **[403]** `https://www.adb.org/news/adb-support-digitalization-government-procurement-kyrgyz-republic` 
    ...
    - referenced by `state/audit/references.json#$.broken[227].samples[2]`
...
- **[403]** `https://www.adb.org/news/adb-supports-digital-trans` 
    ...
    - referenced by `state/audit/references.json#$.broken[228].target`
    - referenced by `state/audit/references.json#$.broken[229].samples[0]`
...
- **[403]** `https://www.adb.org/news/adb-supports-digital-transformation-uzbekistan-s-water-sector` 
    ...
    - referenced by `state/audit/references.json#$.broken[229].samples[1]`
    - referenced by `state/audit/references.json#$.broken[229].samples[2]`
...
- **[403]** `https://www.adb.org/pro` 
    ...
    - referenced by `state/audit/references.json#$.broken[230].target`
...
- **[403]** `https://www.adb.org/projects/` 
    ...
    - referenced by `state/audit/references.json#$.broken[232].target`
...
- **[403]** `https://www.adb.org/projects/country/kgz` 
    ...
    - referenced by `state/audit/references.json#$.broken[238].target`
...
- **[403]** `https://www.adb.org/projects/country/uzb` 
    ...
    - referenced by `state/audit/references.json#$.broken[240].samples[0]`
    - referenced by `state/audit/references.json#$.broken[240].samples[1]`
    - referenced by `state/audit/references.json#$.broken[240].samples[2]`
...
- **[403]** `https://www.dewa.gov.ae/en/about-dewa/dewa-initiatives/smart-grid` 
    ...
    - referenced by `state/audit/references.json#$.broken[242].samples[0]`
    - referenced by `state/audit/references.json#$.broken[242].samples[1]`
    - referenced by `state/audit/references.json#$.broken[242].samples[2]`
...
- **[403]** `https://www.irena.org/countries/Kazakhstan` 
    ...
    - referenced by `state/audit/references.json#$.broken[244].samples[2]`
    - sample: `https://www.irena.org/countries/Kazakhstan`
- **[403]** `https://www.it-park.uz/` 
...
- **[403]** `https://www.kg.undp.org/content/kyrgyzstan/en/home/projects/climate-change-glacial-lakes.html` 
    ...
    - referenced by `state/audit/references.json#$.broken[245].target`
...
- **[403]** `https://www.kg.undp.org/content/kyrgyzstan/en/home/projects/nomadic-heritage-digital.html` 
    ...
    - referenced by `state/audit/references.json#$.broken[246].target`
...
- **[403]** `https://www.npci.org.in/what-we-do/upi/product-overview` 
    ...
    - referenced by `state/audit/references.json#$.broken[250].samples[0]`
    - referenced by `state/audit/references.json#$.broken[250].samples[1]`
    - referenced by `state/audit/references.json#$.broken[250].samples[2]`
...
- **[403]** `https://www.president.kg/` 
    ...
    - referenced by `state/audit/references.json#$.broken[251].target`
...
- **[403]** `https://www.sal.org.sg/` 
    ...
    - referenced by `state/audit/references.json#$.broken[253].target`
...
- **[403]** `https://www.tripadvisor.com/Restaurants-g293964-Samarkand_Samarkand_Province.html` 
    ...
    - referenced by `state/audit/references.json#$.broken[257].target`
...
- **[403]** `https://www.undp.org/bangladesh/blog/bangladesh-models-digital-public-service-delivery-through-union-digita` 
    ...
    - referenced by `state/audit/references.json#$.broken[258].target`
...
- **[403]** `https://www.undp.org/bangladesh/blog/bangladesh-models-digital-public-service-delivery-through-union-digital-` 
    ...
    - referenced by `state/audit/references.json#$.broken[259].target`
...
- **[403]** `https://www.undp.org/central-asia/environment-climate` 
    ...
    - referenced by `state/audit/references.json#$.broken[261].samples[1]`
    - referenced by `state/audit/references.json#$.broken[261].samples[2]`
...
- **[403]** `https://www.undp.org/content/kyrgyzstan/en/home/projects/climate-change-glacial-lakes.html` 
    ...
    - referenced by `state/audit/references.json#$.broken[262].samples[1]`
    - referenced by `state/audit/references.json#$.broken[262].samples[2]`
...
- **[403]** `https://www.undp.org/content/kyrgyzstan/en/home/projects/nomadic-heritage-digital.html` 
    ...
    - referenced by `state/audit/references.json#$.broken[263].target`
...
- **[403]** `https://www.undp.org/kyrgyzstan/press-releases/building-connected-digital-future-kyrgyzstan-strengthens-gov` 
    ...
    - referenced by `state/audit/references.json#$.broken[267].samples[1]`
    - referenced by `state/audit/references.json#$.broken[267].samples[2]`
    - referenced by `state/audit/references.json#$.broken[267].target`
...
- **[403]** `https://www.undp.org/kyrgyzstan/press-releases/building-connected-digital-future-kyrgyzstan-strengthens-govte` 
    ...
    - referenced by `state/audit/references.json#$.broken[268].samples[1]`
    - referenced by `state/audit/references.json#$.broken[268].samples[2]`
...
- **[403]** `https://www.undp.org/kyrgyzstan/press-releases/kyrgyzstan-confidently-advancing-path-digital-transformation` 
    ...
    - referenced by `state/audit/references.json#$.broken[270].samples[1]`
    - referenced by `state/audit/references.json#$.broken[270].samples[2]`
...
- **[403]** `https://www.undp.org/kyrgyzstan/press-releases/united-nations-launches-joint-digital-health-programme-kyrgy` 
    ...
    - referenced by `state/audit/references.json#$.broken[271].samples[1]`
    - referenced by `state/audit/references.json#$.broken[271].samples[2]`
...
- **[403]** `https://www.undp.org/kyrgyzstan/press-releases/united-nations-launches-joint-digital-health-programme-kyrgyzs` 
    ...
    - referenced by `state/audit/references.json#$.broken[272].target`
...
- **[403]** `https://www.undp.org/kyrgyzstan/projects/digital-skills-and-youth-employment-opportunities-digital-economy-` 
    ...
    - referenced by `state/audit/references.json#$.broken[274].samples[1]`
    - referenced by `state/audit/references.json#$.broken[274].samples[2]`
...
- **[403]** `https://www.undp.org/kyrgyzstan/projects/digital-skills-and-youth-employment-opportunities-digital-economy-ky` 
    ...
    - referenced by `state/audit/references.json#$.broken[275].samples[1]`
    - referenced by `state/audit/references.json#$.broken[275].samples[2]`
...
- **[403]** `https://www.undp.org/kyrgyzstan/projects/gender-mainstreaming-digital-transformation-good-governance` 
    ...
    - referenced by `state/audit/references.json#$.broken[277].samples[1]`
    - referenced by `state/audit/references.json#$.broken[277].samples[2]`
...
- **[403]** `https://www.undp.org/uzbekistan` 
    ...
    - referenced by `state/audit/references.json#$.broken[278].samples[1]`
...
- **[403]** `https://www.undp.org/uzbekistan/press-releases/driving-digital-transformation-eu-and-undp-upskill-ict-speci` 
    ...
    - referenced by `state/audit/references.json#$.broken[279].target`
...
- **[403]** `https://www.undp.org/uzbekistan/pro` 
    ...
    - referenced by `state/audit/references.json#$.broken[281].samples[2]`
    - referenced by `state/audit/references.json#$.broken[281].target`
...
- **[403]** `https://www.undp.org/uzbekistan/projects/further` 
    ...
    - referenced by `state/audit/references.json#$.broken[282].samples[1]`
    - referenced by `state/audit/references.json#$.broken[282].samples[2]`
...
- **[403]** `https://www.unicef.org/inno` 
    ...
    - referenced by `state/audit/references.json#$.broken[286].target`
    - referenced by `state/audit/references.json#$.ok[651].samples[0]`
...
- **[403]** `https://www.unicef.org/kyrgyzstan/press-releases/ministry-education-and-science-and-unicef-launch-digital-innovations-support-early` 
    ...
    - referenced by `state/audit/references.json#$.ok[653].samples[1]`
    - referenced by `state/audit/references.json#$.ok[653].samples[2]`
...
- **[404]** `https://aifc.kz/en/` 
    ...
    - referenced by `state/audit/references.json#$.broken[289].samples[1]`
    - referenced by `state/audit/references.json#$.broken[289].samples[2]`
...
- **[404]** `https://avaluev.github.io/ca-b2g-rese` 
    ...
    - referenced by `state/audit/references.json#$.broken[290].target`
...
- **[404]** `https://avaluev.github.io/ca-b2g-resea` 
    ...
    - referenced by `state/audit/references.json#$.broken[291].target`
...
- **[404]** `https://avaluev.github.io/ca-b2g-resear` 
    ...
    - referenced by `state/audit/references.json#$.broken[292].target`
...
- **[404]** `https://cointelegraph.com/news/kyrgyzstan-president-signs-cbdc-law-giving-digital-som-legal-status` 
    ...
    - referenced by `state/audit/references.json#$.broken[296].samples[0]`
    - referenced by `state/audit/references.json#$.broken[296].samples[1]`
    - referenced by `state/audit/references.json#$.broken[296].samples[2]`
...
- **[404]** `https://devtracker.fcdo.gov.uk/progr` 
    - referenced by `state/audit/references.json#$.broken[297].samples[0]`
    - referenced by `state/audit/references.json#$.broken[297].samples[1]`
    - referenced by `state/audit/references.json#$.broken[297].samples[2]`
    - referenced by `state/audit/references.json#$.broken[297].target`
    - referenced by `state/audit/references.json#$.ok[200].samples[0]`
...
- **[404]** `https://digital.gov.kg/wp-content/uploads/2024/06/plan-meropriyatij-po-realizaczii-konczepczii-czifrovoj-tr` 
    - referenced by `state/audit/references.json#$.broken[298].samples[0]`
    - referenced by `state/audit/references.json#$.broken[298].samples[1]`
    - referenced by `state/audit/references.json#$.broken[298].samples[2]`
    - referenced by `state/audit/references.json#$.broken[298].target`
...
- **[404]** `https://digital.gov.kg/wp-content/uploads/2024/06/plan-meropriyatij-po-realizaczii-konczepczii-czifrovoj-transformaczii-kyrgyzskoj-respubliki-na-2024-2028-gody` 
    - referenced by `state/audit/references.json#$.broken[299].samples[0]`
    - referenced by `state/audit/references.json#$.broken[299].samples[1]`
    - referenced by `state/audit/references.json#$.broken[299].samples[2]`
    - referenced by `state/audit/references.json#$.broken[299].target`
    - referenced by `state/audit/references.json#$.broken[300].samples[1]`
...
- **[404]** `https://digital.gov.kg/wp-content/uploads/2024/06/plan-meropriyatij-po-realizaczii-konczepczii-czifrovoj-transformaczii-kyrgyzskoj-respubliki-na-2024-2028-gody.pdf` 
    ...
    - referenced by `state/audit/references.json#$.broken[300].target`
...
- **[404]** `https://diia.gov.ua/en/wartime` 
    ...
    - referenced by `state/audit/references.json#$.broken[301].samples[0]`
    - referenced by `state/audit/references.json#$.broken[301].samples[1]`
    - referenced by `state/audit/references.json#$.broken[301].samples[2]`
    - sample: `https://diia.gov.ua/en/wartime`
- **[404]** `https://documents1.worldbank.org/curated/en/09` 
    - referenced by `state/audit/references.json#$.broken[303].samples[0]`
    - referenced by `state/audit/references.json#$.broken[303].samples[1]`
    - referenced by `state/audit/references.json#$.broken[303].samples[2]`
    - referenced by `state/audit/references.json#$.broken[303].target`
    - referenced by `state/audit/references.json#$.ok[210].samples[0]`
    - sample: `https://documents1.worldbank.org/curated/en/09`
- **[404]** `https://documents1.worldbank.org/curated/en/099042525031049395/` 
    - referenced by `state/audit/references.json#$.broken[304].samples[0]`
    - referenced by `state/audit/references.json#$.broken[304].samples[1]`
    - referenced by `state/audit/references.json#$.broken[304].samples[2]`
    - referenced by `state/audit/references.json#$.broken[304].target`
...
- **[404]** `https://documents1.worldbank.org/curated/en/099042525031049395/pdf/P178562` 
    ...
    - referenced by `state/audit/references.json#$.broken[305].samples[0]`
    - referenced by `state/audit/references.json#$.broken[305].samples[1]`
    - referenced by `state/audit/references.json#$.broken[305].samples[2]`
    - referenced by `state/audit/references.json#$.broken[305].target`
...
- **[404]** `https://e-estonia.com/salme-ai-powered-court-assistant/` 
    ...
    - referenced by `state/audit/references.json#$.broken[306].samples[0]`
    - referenced by `state/audit/references.json#$.broken[306].samples[1]`
    - referenced by `state/audit/references.json#$.broken[306].samples[2]`
...
- **[404]** `https://e-estonia.com/solutions/e-identity/e-residency/` 
    ...
    - referenced by `state/audit/references.json#$.broken[307].samples[0]`
    - referenced by `state/audit/references.json#$.broken[307].samples[1]`
    - referenced by `state/audit/references.json#$.broken[307].samples[2]`
...
- **[404]** `https://e-estonia.com/solutions/e-taxes/e-tax-declaration/` 
    ...
    - referenced by `state/audit/references.json#$.broken[308].samples[0]`
    - referenced by `state/audit/references.json#$.broken[308].samples[1]`
    - referenced by `state/audit/references.json#$.broken[308].samples[2]`
...
- **[404]** `https://e-estonia.com/solutions/energy/smart-grid/` 
    ...
    - referenced by `state/audit/references.json#$.broken[309].samples[0]`
    - referenced by `state/audit/references.json#$.broken[309].samples[1]`
    - referenced by `state/audit/references.json#$.broken[309].samples[2]`
...
- **[404]** `https://e-estonia.com/solutions/healthcare/e-health-record/` 
    ...
    - referenced by `state/audit/references.json#$.broken[310].samples[0]`
    - referenced by `state/audit/references.json#$.broken[310].samples[1]`
    - referenced by `state/audit/references.json#$.broken[310].samples[2]`
...
- **[404]** `https://e-mongolia.mn/education` 
    ...
    - referenced by `state/audit/references.json#$.broken[311].samples[0]`
    - referenced by `state/audit/references.json#$.broken[311].samples[1]`
    - referenced by `state/audit/references.json#$.broken[311].samples[2]`
    - sample: `https://e-mongolia.mn/education`
- **[404]** `https://eadaily.com/ru/news/2025/01/28/v-ki` 
    - referenced by `state/audit/references.json#$.broken[312].samples[0]`
    - referenced by `state/audit/references.json#$.broken[312].samples[1]`
    - referenced by `state/audit/references.json#$.broken[312].samples[2]`
    - referenced by `state/audit/references.json#$.broken[312].target`
    - referenced by `state/audit/references.json#$.ok[217].samples[0]`
...
- **[404]** `https://ec.europa.eu/international-partnerships/where-we-work/central-asia/connectivity-central-asia_en` 
    ...
    - referenced by `state/audit/references.json#$.broken[314].samples[0]`
    - referenced by `state/audit/references.json#$.broken[314].samples[1]`
    - referenced by `state/audit/references.json#$.broken[314].samples[2]`
    - referenced by `state/audit/references.json#$.broken[314].target`
...
- **[404]** `https://economist.kg/vlas` 
    - referenced by `state/audit/references.json#$.broken[315].samples[0]`
    - referenced by `state/audit/references.json#$.broken[315].samples[1]`
    - referenced by `state/audit/references.json#$.broken[315].samples[2]`
    - referenced by `state/audit/references.json#$.broken[315].target`
    - referenced by `state/audit/references.json#$.ok[222].samples[1]`
...
- **[404]** `https://egov.kz/cms/en/about` 
    ...
    - referenced by `state/audit/references.json#$.broken[316].samples[0]`
    - referenced by `state/audit/references.json#$.broken[316].samples[1]`
    - referenced by `state/audit/references.json#$.broken[316].samples[2]`
...
- **[404]** `https://egov.kz/cms/en/articles/health-epsd` 
    ...
    - referenced by `state/audit/references.json#$.broken[317].samples[0]`
    - referenced by `state/audit/references.json#$.broken[317].samples[1]`
    - referenced by `state/audit/references.json#$.broken[317].samples[2]`
...
- **[404]** `https://en.kabar.kg/news/huawei-intends-to-cr` 
    ...
    - referenced by `state/audit/references.json#$.ok[232].samples[0]`
...
- **[404]** `https://github.com/avaluev/ca-b` 
    ...
    - referenced by `state/audit/references.json#$.ok[331].samples[0]`
...
- **[404]** `https://github.com/avaluev/ca-b2g-res` 
    ...
    - referenced by `state/audit/references.json#$.broken[322].samples[1]`
    - referenced by `state/audit/references.json#$.broken[322].samples[2]`
    - referenced by `state/audit/references.json#$.broken[322].target`
    - referenced by `state/audit/references.json#$.ok[288].samples[1]`
...
- **[404]** `https://github.com/avaluev/ca-b2g-research/blob/main/.claude/audit-team/03_content_voice_editor.md` 
    ...
    - referenced by `state/audit/references.json#$.broken[324].samples[2]`
...
- **[404]** `https://github.com/avaluev/ca-b2g-research/blob/main/.claude/audit-team/08_accessibility_wcag_22_aa.md` 
    ...
    - referenced by `state/audit/references.json#$.broken[325].target`
...
- **[404]** `https://github.com/avaluev/ca-b2g-research/raw/main/outputs/crm/FILENAME.csv` 
    ...
    - referenced by `state/audit/references.json#$.broken[328].samples[1]`
    - referenced by `state/audit/references.json#$.broken[328].samples[2]`
...
- **[404]** `https://international-partnerships.ec.europa.eu/countries/central-asia` 
    ...
    - referenced by `state/audit/references.json#$.broken[330].target`
...
- **[404]** `https://international-partnerships.ec.europa.eu/countries/central-asia/connectivity-central-asia_en` 
    ...
    - referenced by `state/audit/references.json#$.broken[331].target`
...
- **[404]** `https://interoperable-europe.ec.europa.eu/collection/egovernment/document/govgr-greece` 
    ...
    - referenced by `state/audit/references.json#$.broken[332].target`
...
- **[404]** `https://joinup.ec.europa.eu/collection/egovernment/document/govgr-greece` 
    ...
    - referenced by `state/audit/references.json#$.broken[333].target`
...
- **[404]** `https://kun.uz/en/news/2026/04/27/` 
    ...
    - referenced by `state/audit/references.json#$.broken[337].samples[1]`
    - referenced by `state/audit/references.json#$.broken[337].samples[2]`
    - referenced by `state/audit/references.json#$.broken[337].target`
    - referenced by `state/audit/references.json#$.ok[349].samples[0]`
...
- **[404]** `https://kun.uz/ru/news/2024/12/15/uzbek-academia` 
    ...
    - referenced by `state/audit/references.json#$.broken[340].target`
...
- **[404]** `https://kun.uz/ru/news/2025/03/10/mahalla-shikoyatlar` 
    ...
    - referenced by `state/audit/references.json#$.broken[341].target`
...
- **[404]** `https://kun.uz/ru/news/2025/09/15/elektronnoe-pravitelstvo-mahalla` 
    ...
    - referenced by `state/audit/references.json#$.broken[342].target`
...
- **[404]** `https://lex.uz/d` 
    ...
    - referenced by `state/audit/references.json#$.ok[366].samples[1]`
...
- **[404]** `https://lex.uz/do` 
    ...
    - referenced by `state/audit/references.json#$.broken[344].target`
    - referenced by `state/audit/references.json#$.ok[362].samples[1]`
...
- **[404]** `https://lex.uz/ru/do` 
    ...
    - referenced by `state/audit/references.json#$.ok[371].samples[1]`
...
- **[404]** `https://lex.uz/ru/doc` 
    ...
    - referenced by `state/audit/references.json#$.ok[369].samples[1]`
...
- **[404]** `https://lex.uz/ru/docs/677` 
    ...
    - referenced by `state/audit/references.json#$.ok[382].samples[1]`
...
- **[404]** `https://lex.uz/uz/docs/` 
    - referenced by `state/audit/references.json#$.broken[353].samples[0]`
    - referenced by `state/audit/references.json#$.broken[353].samples[1]`
    - referenced by `state/audit/references.json#$.broken[353].samples[2]`
    - referenced by `state/audit/references.json#$.broken[353].target`
    - referenced by `state/audit/references.json#$.ok[406].samples[1]`
...
- **[404]** `https://www.apache.org/licenses/LICEN` 
    ...
    - referenced by `state/audit/references.json#$.broken[361].target`
    - referenced by `state/audit/references.json#$.ok[329].samples[0]`
...
- **[404]** `https://www.cigre.org/technical-publications/cigre-technical-brochure-predictive-maintenance` 
    ...
    - referenced by `state/audit/references.json#$.broken[363].target`
...
- **[404]** `https://www.clevelandart.org/artlens-gallery/artlens-ai` 
    ...
    - referenced by `state/audit/references.json#$.broken[364].samples[0]`
    - referenced by `state/audit/references.json#$.broken[364].samples[1]`
    - referenced by `state/audit/references.json#$.broken[364].samples[2]`
    - referenced by `state/audit/references.json#$.broken[364].target`
...
- **[404]** `https://www.ebrd.com/content/dam/ebrd_dxp/assets/pdfs/country-strate` 
    ...
    - referenced by `state/audit/references.json#$.ok[555].samples[0]`
...
- **[404]** `https://www.eeas.europa.eu/dele` 
    ...
    - referenced by `state/audit/references.json#$.ok[561].samples[0]`
...
- **[404]** `https://www.eeas.europa.eu/delegations/kyrgyz-republic/global-gatew` 
    ...
    - referenced by `state/audit/references.json#$.ok[560].samples[0]`
...
- **[404]** `https://www.eucybernet.eu/project/connectivity-for-c` 
    ...
    - referenced by `state/audit/references.json#$.ok[566].samples[2]`
...
- **[404]** `https://www.euronews.com/20` 
    ...
    - referenced by `state/audit/references.json#$.ok[567].samples[0]`
    - sample: `https://www.euronews.com/20`
- **[404]** `https://www.gazeta.uz/ru/list/economy/agriculture/` 
...
- **[404]** `https://www.gazeta.uz/ru/list/health/` 
...
- **[404]** `https://www.gazeta.uz/ru/list/society/` 
    ...
    - referenced by `state/audit/references.json#$.broken[380].target`
...
- **[404]** `https://www.ilo.org/asia/countries/india/WCMS_832540/lang--en/index.htm` 
    ...
    - referenced by `state/audit/references.json#$.broken[381].samples[1]`
    - referenced by `state/audit/references.json#$.broken[381].samples[2]`
...
- **[404]** `https://www.ilo.org/global/about-the-ilo/newsroom/news/WCMS_887302/lang--en/index.htm` 
    ...
    - referenced by `state/audit/references.json#$.broken[382].samples[1]`
    - referenced by `state/audit/references.json#$.broken[382].samples[2]`
...
- **[404]** `https://www.isdb.org/news/islamic-develop` 
    ...
    - referenced by `state/audit/references.json#$.broken[384].target`
    - referenced by `state/audit/references.json#$.ok[596].samples[0]`
...
- **[404]** `https://www.just.ee/en/courts/court-administration/e-court` 
    ...
    - referenced by `state/audit/references.json#$.broken[385].target`
...
- **[404]** `https://www.nao.org.uk/reports/digital-transformation-of-services/` 
    ...
    - referenced by `state/audit/references.json#$.broken[390].target`
...
- **[404]** `https://www.opensocietyfoundations.org/newsroom/open-soci` 
    ...
    - referenced by `state/audit/references.json#$.broken[391].target`
    - referenced by `state/audit/references.json#$.ok[640].samples[0]`
...
- **[404]** `https://www.spot.uz/ru/2024/06/02/dtm-tutors/` 
    ...
    - referenced by `state/audit/references.json#$.broken[399].target`
...
- **[404]** `https://www.spot.uz/ru/2024/06/12/biometric-passport/` 
    ...
    - referenced by `state/audit/references.json#$.broken[400].target`
...
- **[404]** `https://www.spot.uz/ru/2024/10/10/mental-health/` 
    ...
    - referenced by `state/audit/references.json#$.broken[404].target`
...
- **[404]** `https://www.spot.uz/ru/2025/02/11/biznes-permits/` 
    ...
    - referenced by `state/audit/references.json#$.broken[406].target`
...
- **[404]** `https://www.spot.uz/ru/2025/05/14/zhaloba-guide/` 
    ...
    - referenced by `state/audit/references.json#$.broken[407].target`
...
- **[404]** `https://www.spot.uz/ru/2025/10/22/epigu/` 
    ...
    - referenced by `state/audit/references.json#$.broken[408].target`
...
- **[404]** `https://www.syke.fi/en/en-US/Research__Development/ICT_and_digitalization` 
    ...
    - referenced by `state/audit/references.json#$.broken[419].target`
...
- **[404]** `https://www.worldbank.org/en/country/kyrgyzrepublic/brief/kyrgyz-republic-energy-sector` 
    ...
    - referenced by `state/audit/references.json#$.broken[437].samples[0]`
    - referenced by `state/audit/references.json#$.broken[437].samples[1]`
    - referenced by `state/audit/references.json#$.broken[437].samples[2]`
...
- **[404]** `https://www.worldbank.org/en/country/uzbekistan/brief/energy` 
    ...
    - referenced by `state/audit/references.json#$.broken[438].samples[1]`
    - referenced by `state/audit/references.json#$.broken[438].samples[2]`
...
- **[404]** `https://www.worldbank.org/en/country/uzbekistan/brief/water-resources-management` 
    ...
    - referenced by `state/audit/references.json#$.broken[439].samples[2]`
...
- **[404]** `https://www.worldbank.org/en/country/uzbekistan/projects` 
    ...
    - referenced by `state/audit/references.json#$.broken[440].samples[2]`
    - referenced by `state/audit/references.json#$.broken[440].target`
...
- **[404]** `https://www.worldbank.org/en/news/press-release/2023/11/30/world-bank-to-support-u` 
    ...
    - referenced by `state/audit/references.json#$.broken[442].samples[2]`
    - referenced by `state/audit/references.json#$.broken[442].target`
...
- **[404]** `https://www.worldbank.org/en/news/press-release/2023/11/30/world-bank-to-support-uzbekistan-in-developing-the-digital-economy-and-creating-new-jobs-in-the-it-se` 
    ...
    - referenced by `state/audit/references.json#$.ok[663].samples[1]`
...
- **[404]** `https://www.worldbank.org/en/news/press-release/2024/01/12/world-b` 
    ...
    - referenced by `state/audit/references.json#$.ok[664].samples[2]`
...
- **[404]** `https://www.worldbank.org/en/programs/korea-world-ban` 
    ...
    - referenced by `state/audit/references.json#$.ok[666].samples[0]`
...
- **[404]** `https://www.worldbank.org/en/projects/p160230` 
    ...
    - sample: `[Open tender](https://www.worldbank.org/en/projects/p160230)`
...
- **[418]** `https://egov.uz` 
    - referenced by `outputs/obsidian/Institutions/uz-egov-center.md:36`
    - referenced by `state/audit/link_report.json#$.results[124].final_url`
    - referenced by `state/audit/link_report.json#$.results[124].url`
    - referenced by `state/audit/link_report.json#$.results[210].final_url`
    - referenced by `state/audit/link_report.json#$.results[210].url`
    - sample: `- [E-Government Center Uzbekistan](https://egov.uz) (ru)`
- **[429]** `https://www.linkedin.com/in/aigerim-bekova-wb` 
...
- **[429]** `https://www.linkedin.com/in/alisher-tashkentov-samsung` 
...
- **[429]** `https://www.linkedin.com/in/dostonbek-toshmatov` 
...
- **[429]** `https://www.linkedin.com/in/marco-mantovanelli-wb` 
...
- **[429]** `https://www.linkedin.com/in/sardor-jabbor-uz` 
    ...
    - referenced by `state/audit/references.json#$.broken[492].samples[0]`
...
- **[429]** `https://www.linkedin.com/in/yun-ji-suh-adb` 
    ...
    - referenced by `state/audit/references.json#$.broken[499].samples[1]`
...
- **[500]** `https://www.aa.com.tr/ru/%D0%BC%D0%B8%D1%80/%D0` 
    ...
    - referenced by `state/audit/references.json#$.broken[458].target`
    - referenced by `state/audit/references.json#$.ok[540].samples[1]`
...
- **[999]** `https://www.linkedin.com/in/akbar-toshmatov-stanford` 
...
- **[999]** `https://www.linkedin.com/in/bahador-rakhmatov` 
    ...
    - referenced by `state/audit/references.json#$.broken[466].samples[1]`
...
- **[999]** `https://www.linkedin.com/in/bobur-yakubov-mit` 
    ...
    - referenced by `state/audit/references.json#$.broken[468].samples[1]`
...
- **[999]** `https://www.linkedin.com/in/elvira-janbekova-aieb` 
...
- **[999]** `https://www.linkedin.com/in/emil-bakytbekov` 
    ...
    - referenced by `state/audit/references.json#$.broken[473].samples[0]`
    - referenced by `state/audit/references.json#$.broken[473].samples[1]`
...
- **[999]** `https://www.linkedin.com/in/naveed-hassan-naqvi` 
...
- **[999]** `https://www.linkedin.com/in/ozod-tashpulatov-wb` 
    ...
    - referenced by `state/audit/references.json#$.broken[490].samples[0]`
    - referenced by `state/audit/references.json#$.broken[490].samples[1]`
    - sample: `linkedin_url: "https://www.linkedin.com/in/ozod-tashpulatov-wb"`
- **[999]** `https://www.linkedin.com/in/sandra-sargent-worldbank` 
...
- **[999]** `https://www.linkedin.com/in/timur-koichubaev` 
